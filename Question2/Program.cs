    ...
    internal class Program
    {
        ...
        static void DisplayMenu()
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("5. Print player infomation to file");
        ...
        static void DisplayAllPlayers()
        {
            ...
            {
                connection.Open();
                string searchQuery = "SELECT * FROM Players LIMIT 10";
                using (var command = new SQLiteCommand(searchQuery, connection))
                {
                    using (var reader = command.ExecuteReader())
                    {
        ...
        static void PrintPlayerInformation()
        {
            string filePath = "player_information.txt";
                    ...
                    using (var reader = command.ExecuteReader())
                    {
                        if (reader.HasRows)
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                writer.WriteLine($"Name: {reader["Name"]}, Age: {reader["Age"]}, Position: {reader["Position"]}");
                            }
                            Console.WriteLine("Player information printed to player_information.txt.\n");
                        }
                        else
                        {
                            Console.WriteLine("There are no players.\n");
